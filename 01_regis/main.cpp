...
int main()
{
    ...
    Eigen::Matrix4f T_optimized_result;
    optimized_icp.Match(cloud_source_ptr, T_predict, cloud_source_opti_transformed_ptr, T_optimized_result);
    
    std::cout << "\n============== Optimized ICP =================" << std::endl;
    std::cout << "T final: \n" << T_optimized_result << std::endl;
    std::cout << "fitness score: " << optimized_icp.GetFitnessScore() << std::endl;
    std::cout << "has converged: " << (optimized_icp.HasConverged() ? "true" : "false") << std::endl;
    // =======================   optimized icp   =======================
